...
class Mario(pg.sprite.Sprite):
    ...
    def setup_state_booleans(self):
        """Configura os valores booleanos que afetam o comportamento do Mario"""
    ...
    def setup_forces(self):
        """Define as forças que afetam a velocidade do Mario"""
        self.x_vel = 0
        self.y_vel = 0
    ...
    def setup_counters(self):
        """Estas acompanhar de vários total para valores importantes"""
        self.frame_index = 0
    ...
    def load_images_from_sheet(self):
        """Extrai imagens do Mario de sua folha de sprite e atribui
-los para listas apropriada"""
        self.right_frames = []
        self.left_frames = []
        ...
        # imagens do mario normal, pequeno#
        ...
        # Imagens do mario verde pequena (para animação invencível)
        ...
        # Imagens do mario vermelho (para animação invencível)#
