...
class Coin(pg.sprite.Sprite):
    """Piscando a moeda ao lado de informação total de moeda
"""
    ...
    def create_frames(self):
        """Extrair imagens de moeda da folha de sprite e atribuí-los a uma lista"""
        self.frames = []
        self.frame_index = 0
    ...
    def get_image(self, x, y, width, height):
        ...
        image = pg.transform.scale(image,
                                   (int(rect.width*c.BRICK_SIZE_MULTIPLAYER),
                                    int(rect.height*c.BRICK_SIZE_MULTIPLAYER)))
        return image


    def update(self, current_time):
        """Anima a moeda piscando"""
        if self.first_half:
