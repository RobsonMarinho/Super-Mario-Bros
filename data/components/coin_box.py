...
class Coin_box(pg.sprite.Sprite):
    ...
    def get_image(self, x, y, width, height):
        """Extraindo a imagem da caixa das listas"""
    ...
    def setup_frames(self):
        """Creando a lista de quadro com as imagens"""
        self.frames.append(
    ...
    def update(self, game_info):
        """Atualizar o comportamento da caixa de moeda"""
        self.current_time = game_info[c.CURRENT_TIME]
        self.handle_states()


    def handle_states(self):
        """Determinar a ação com base no descanso, BUMPED ou OPENED
estado"""
    ...
    def resting(self):
        """Ação quando em estado de descanso"""
        if self.first_half:
    ...
    def bumped(self):
        """Ação depois que Mario tem colidido a caixa de baixo"""
    ...
    def start_bump(self, score_group):
        """Caixa de transições em BUMPED estado"""
        self.y_vel = -6
        self.state = c.BUMPED
    ...
    def opened(self):
        """Espaço reservado para o estado aberto"""
        pass