...
class Character(pg.sprite.Sprite):
    """Classe pai para todos os caracteres usados pela
classe de carregamento de info"""
...
class OverheadInfo(object):
    """Classe para obter informações de nível como pontuação, total de moeda, 
e tempo restante"""
    ...
    def create_load_screen_labels(self):
        """Cria rótulos para a informação do centro de uma tela 
de carregamento"""
        world_label = []
        number_label = []
